...
package it.unibo.cvlab.pydnet.demo;
...
public class Size implements Comparable<Size>, Serializable {
    ...
    public final float widthFloat;
    public final float heightFloat;

    public Size(final int width, final int height) {
        this.width = width;
        this.height = height;
        this.widthFloat = (float) this.width;
        this.heightFloat = (float) this.height;
    }
    ...
    public final float aspectRatio(int rotation){
        switch (rotation) {
            case 90:
            case 270:
                return  heightFloat / widthFloat;
            case 0:
            case 180:
                return widthFloat / heightFloat;
            default:
                throw new RuntimeException("Unhandled rotation: " + rotation);
        }
    }
