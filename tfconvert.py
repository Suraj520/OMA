...
DATASET_PATH = "/home/luca/Scrivania/OMA/datasets/generated/15042020_095730/images/"
DATASET_SIZE = 268

#CROP_RES = (640,448)
CROP_RES = (640,384)

GRAPH_PB_PATH = "/home/luca/Scrivania/OMA/optimizations/default/frozen_pydnet_v3.pb"
GRAPH_TFLITE_PATH = "/home/luca/Scrivania/OMA/optimizations/default/frozen_pydnet_v3.tflite"
...
#GRAPH_PB_PATH = "/home/luca/Scrivania/OMA/optimizations/default/frozen_dsnet.pb"
#GRAPH_TFLITE_PATH = "/home/luca/Scrivania/OMA/optimizations/default/tflite_dsnet.tflite"
...
#input_tensor = session.graph.get_tensor_by_name("im0")
#input_tensor.set_shape([1,448,640,3])
#input_tensor.set_shape([1,384,640,3])

#out_tensor_half = session.graph.get_tensor_by_name("PSD/resize_images/ResizeBilinear")
#out_tensor_half.set_shape([1,384,640,1])
...
#doutput_tensors = [out_tensor_half]
...
#output_tensors = ["MonocularNetwork/half"]
output_tensors = ["decoder/half/resize/ResizeBilinear"]
#input_shapes = {'im0': [1,448,640,3]}
input_shapes = {'im0': [1,384,640,3]}
...
converter.quantized_input_stats = {"im0": (0.0, 255.0)}
converter.default_ranges_stats = (0.0, 255.0)
